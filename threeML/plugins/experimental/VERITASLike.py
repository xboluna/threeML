...
class VERITASRun(object):
    def __init__(self, root_file, run_name):
        ...
        with open_ROOT_file(root_file) as f:
            ...
            self._log_recon_energies, self._log_mc_energies, self._hMigration = th2_to_arrays(
                f.Get(run_name + "/hMigration")
            )
            ...
            self._eff_area *= (
                1e8
            )  # This value is for VEGAS, because VEGAS effective area is in cm2
