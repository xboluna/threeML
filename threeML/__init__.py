...
from threeML.io.data_access.Fermi_GBM.download_GBM_data import download_GBM_trigger_data, cleanup_downloaded_GBM_data

# Import LAT downloader
from threeML.io.data_access.Fermi_LAT.download_LAT_data import download_LAT_data

# Import LLE downloader
from threeML.io.data_access.Fermi_LAT.download_LLE_data import download_LLE_trigger_data, cleanup_downloaded_LLE_data
